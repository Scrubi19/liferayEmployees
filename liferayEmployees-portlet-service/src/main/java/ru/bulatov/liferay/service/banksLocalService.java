...
/**
 * Provides the local service interface for banks. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see banksLocalServiceUtil
...
public interface banksLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link banksLocalServiceUtil} to access the banks local service. Add custom service methods to {@link ru.bulatov.liferay.service.impl.banksLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
